...
ExecStart=/usr/share/ovn/scripts/ovn-ctl --db-nb-addr=ovn-cluster-1 --db-nb-cluster-local-addr=ovn-cluster-1 run_nb_ovsdb
...
ExecStart=/usr/share/ovn/scripts/ovn-ctl --db-sb-addr=ovn-cluster-1 --db-sb-cluster-local-addr=ovn-cluster-1 run_sb_ovsdb
